...
Camera camera((float)WIDTH / 2, (float)HEIGHT / 2, 0.0, 0.0, 0); //set up a camera
/***************************************************************************/
...
void display ( void )   // Create The Display Function
{
  ...
  // CALL YOUR CODE HERE
	...
	renderer.render(objhandler, camera);//renderer handles drawing, so tell it to draw the object
	//objhandler.draw();
